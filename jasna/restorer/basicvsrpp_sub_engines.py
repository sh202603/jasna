...
def _try_create_fp8_upsample(
    ...
    try:
        ...
        return CudnnFP8Upsample(generator, device, max_clip_size)
...
def create_split_forward(
    ...
    fp8_upsample = _try_create_fp8_upsample(generator, device, fp16, max_clip_size)
    result = load_sub_engines(
        model_weights_path, device, fp16, max_clip_size,
