...
KO = {
        ...
        "tip_vr_mode": "좌우 분할 VR180 처리 방식을 설정합니다.\n\n자동은 높이가 1080픽셀을 넘는 정확한 2:1 프레임, 신뢰할 수 있는 스튜디오 파일명 토큰 또는 호환 공간 메타데이터가 있을 때 활성화됩니다. SBS는 양쪽 눈을 각각 감지하고 복원합니다. SBS + 어안은 감지 신뢰도를 높이기 위해 각 눈을 재투영한 뒤 복원된 영역만 원본 투영에 다시 합성합니다.\n\n구간 편집기는 왼쪽 눈만 표시하지만 스캔과 내보내기는 양쪽 눈을 처리합니다.\n기본값: 자동",
