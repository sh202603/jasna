...
JA = {
        ...
        "segments_ab_compare": "A/B 比較…",
        "segments_ab_compare_hint": "検出／復元モデルの 2 つの組み合わせを現在のフレームで左右比較します",
        "ab_title": "A/B モデル比較",
        "ab_view_restored": "復元",
        "ab_view_detection": "検出",
        "ab_view_clip": "クリップ",
        "ab_run": "実行",
        ...
        "ab_stale_hint": "（未反映）",
        "ab_checkpoint_missing_ema": "チェックポイント {name} には EMA 重み（generator_ema.*）がなく、ランダム重みで動作するため拒否しました",
        "ab_no_detection": "このフレームに検出はありません",
        "ab_score": "検出スコア：{score}",
        "ab_step_second_back": "1 秒戻る",
        ...
        "ab_compile_done": "エンジンのコンパイルが完了しました",
        "ab_compile_failed": "エンジンのコンパイルに失敗しました：{message}",
